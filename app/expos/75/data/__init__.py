...
def build(app):
    ...
    app.imagemap = imagemap = ImageMap(
            ...
            sources=sources,
            suffix='_active')
    s = Scatter(rotation=90,pos_hint=app.imagemap.pos_hint,auto_bring_to_front=False,\
                size=app.imagemap.size,size_hint=(None,None),\
    ...
    app.keywords = Keywords(
            size=(500, 250),
            size_hint=(None, None),color_file='widgets/test.png',color_file_selected='widgets/test_down.png', or_and=False)
    ...
    def set_ordering_origin_pos(instance, value):
        ordering_origin.y = instance.y+instance.width
        ordering_origin.x = instance.x
